...
public class RutasFicheros {
    ...
    public static String RUTA_FICHERO = "src/Trimestre1/T01/Ejercicios/Ficheros/Fichero.txt";
    public static String RUTA_FICHERO_TEMPORAL = "src/Trimestre1/T01/Ejercicios/Ficheros/FicheroTemporal.txt";
}
